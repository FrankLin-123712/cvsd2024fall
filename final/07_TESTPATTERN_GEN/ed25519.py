...
class point:
	...
	def __mul__(self, M: int) -> 'point':
		...
		for i in range(255):
			...
			# print(f"Iteration {i}")
			# print("-------- After r+r -------")
			# print("Xr : {:064x}".format(r.X.value))
			# print("Yr : {:064x}".format(r.Y.value))
			# print("Zr : {:064x}".format(r.Z.value))
			if(M_in_bin[i]=="1"):
				r = r + self
				# print("-------- After r+p --------")
				# print("Xr : {:064x}".format(r.X.value))
	...
	def reduce(self) -> 'point':
		# print("------- Before reduce --------")
		# print("Xmp : {:064x}".format(self.X.value))
		# print("Ymp : {:064x}".format(self.Y.value))
		# print("Zmp : {:064x}".format(self.Z.value))
		x = self.X/self.Z
		y = self.Y/self.Z
